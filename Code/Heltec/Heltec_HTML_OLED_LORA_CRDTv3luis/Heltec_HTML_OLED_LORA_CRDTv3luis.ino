...
// Hilfsfunktion zum Parsen eines MAC‑Strings "AA:BB:CC" in eine 48‑Bit‑Zahl
uint64_t parseMac(const String &s) {
  uint64_t v = 0;
...
// --- Helper: Update or create ID entry ---
...
/**
/ Received ID list is compared with our own entries for each esp
*/
